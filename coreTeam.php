            ...
            <!-- <div class="row">
                <div class="col-md-3">
                    <div class="fh5co-person text-center to-animate">
                        <figure>
                            <img src="images/speakers/directorsir.jpg" alt="Image">
                        </figure>
...
<section id="fh5co-about" data-section="about">
    <div class="container-fluid" style="margin-top: 40px">
        <div class="row">
            <div class="col-md-12 section-heading text-center">
                <h2 class="to-animate">Events Management</h2>
                <div class="row">
                    <!-- <div class="col-md-8 col-md-offset-2 subtext to-animate">
                        <h3>Core Team of IIIC</h3>
                    </div> -->
            ...
            <div class="col-md-6">
                <div class="fh5co-person text-center to-animate">
                    ...
                    <ul class="social social-circle">
                        ...
                        <li>
                            <a href="mailto:iit2017076@iiita.ac.in">
                                <i class="icon-envelope"></i>
                            </a>
                        </li>
                    </ul>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="fh5co-person text-center to-animate">
                <figure>
                    <img src="team/rahul.jpg" alt="Image">
                </figure>
                <h3>Rahul Naidu</h3>
                <span class="fh5co-position">Executive, Events Management</span>
                <p></p>
    ...
    <div class="container-fluid" style="margin-top: 40px">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="fh5co-person text-center to-animate">
                    <figure>
                        <img src="team/harshit.jpg" alt="Image">
                    </figure>
                    <h3>Harshit Dixit</h3>
                    <span class="fh5co-position">Head, Corporate Relations</span>
                    <ul class="social social-circle">
...
<section id="fh5co-about" data-section="about">
    <div class="container-fluid" style="margin-top: 40px">
            ...
            <div class="col-md-6">
                <div class="fh5co-person text-center to-animate">
                    ...
                    <ul class="social social-circle">
                        ...
                        <li>
                            <a href="https://www.facebook.com/mohit.gupta.75491856">
                                <i class="icon-facebook"></i>
                            </a>
                        </li>
                        <li>
                            <a href="mailto:iit2017052@iiita.ac.in">
                                <i class="icon-envelope"></i>
                            </a>
                        </li>
                    </ul>
        ...
        <div class="col-md-4">
            <div class="fh5co-person text-center to-animate">
                <figure>
                    <img src="team/kanishq.jpeg" alt="Image">
                </figure>
                <h3>Kanishq Rohila</h3>
                <span class="fh5co-position">Executive, Public Relations &amp; Marketing</span>
                <ul class="social social-circle">
                    <li>
                        <a href="#">
...
<section id="fh5co-about" data-section="about">
    <div class="container-fluid" style="margin-top: 40px">
        <div class="row">
            <div class="col-md-12 section-heading text-center">
                <h2 class="to-animate">Media Management</h2>
                <div class="row">
                    <!-- <div class="col-md-8 col-md-offset-2 subtext to-animate">
                        <h3>Core Team of IIIC</h3>
                    </div> -->
            ...
            <div class="col-md-6">
                <div class="fh5co-person text-center to-animate">
                    ...
                    <ul class="social social-circle">
                        ...
                        <li>
                            <a href="https://www.facebook.com/jasmeet.kaur2112">
                                <i class="icon-facebook"></i>
                            </a>
                        </li>
                        <li>
                            <a href="mailto:iit2017078@iiita.ac.in">
                                <i class="icon-envelope"></i>
                            </a>
                        </li>
                    </ul>
        ...
        <
            ...
            <div class="col-md-3">
                <div class="fh5co-person text-center to-animate">
                    <figure>
                        <img src="team/ananya.jpg" alt="Image">
                    </figure>
...
<section id="fh5co-about" data-section="about">
    <div class="container-fluid" style="margin-top: 40px">
        <div class="row">
            <div class="col-md-12 section-heading text-center">
                <h2 class="to-animate">Web Operations</h2>
                <div class="row">
                    <!-- <div class="col-md-8 col-md-offset-2 subtext to-animate">
                        <h3>Core Team of IIIC</h3>
                    </div> -->
            ...
            <div class="col-md-3">
                <div class="fh5co-person text-center to-animate">
                    ...
                    <ul class="social social-circle">
                        ...
                        <li>
                            <a href="https://www.facebook.com/tanmay.mittal.106">
                                <i class="icon-facebook"></i>
                            </a>
                        </li>
                        <li>
            ...
            <div class="col-md-3">
                <div class="fh5co-person text-center to-animate">
                    ...
                    <ul class="social social-circle">
                        ...
                        <li>
                            <a href="mailto:iec2018132@iiita.ac.in">
                                <i class="icon-envelope"></i>
                            </a>
                        </li>
                    </ul>
